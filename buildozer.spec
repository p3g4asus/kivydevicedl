...
# (str) Package name
package.name = devicedl

# (str) Package domain (needed for android/ios packaging)
package.domain = org.kivymfz
...
requirements = android,libffi,python3,oscpy,kivy
...
services = ShortcutService:./service/shortcut_service.py
...
# (list) Permissions
android.permissions = INTERNET,READ_EXTERNAL_STORAGE,FOREGROUND_SERVICE, ACCESS_NETWORK_STATE
...
p4a.local_recipes = %(source.dir)s/../../custom_recipes
